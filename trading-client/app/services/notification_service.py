...
def create_notification(
    ...
    *,
    ...
    Args:
        type: trade_executed, signal_alert, stop_loss_hit, take_profit_hit,
        ...
        action_url: Optional page to navigate to when clicked
        metadata: Optional extra context dict
        user_id: User ID (default 0 for single-user)
    """
    try:
        notif = Notification(
            user_id=user_id,
