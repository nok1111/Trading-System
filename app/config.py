...
class Settings(BaseSettings):
    ...
    por defecto el trading real está deshabilitado y el modo es backtest.
    """
    ...
    DEFAULT_SYMBOLS: str = "SPY,AAPL,MSFT"
    ...
    # Capital asignado al AI Agent (0 = usar todo el saldo disponible)
